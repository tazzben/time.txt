...
<pre>
./time +project or @bob --save="results.txt"
</pre>
...
<pre>
./time +project and ">4-20-2011" --save="results.csv"
</pre>
...
Max/Linux/Etc (tar.gz file): "https://github.com/tazzben/time.txt/blob/master/dist/time.tar.gz":https://github.com/tazzben/time.txt/blob/master/dist/time.tar.gz?raw=true